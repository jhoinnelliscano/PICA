...
namespace eCommerce.ShoppingCart.Infraestructure.Services
{
    public class ShoppingCartService : IShoppingCartService
    {
        ...
        {
            var result = await _shoppingCartWriteRepository.UpdateShoppingCartStatus(porductId, status);
            _unitOfWork.Confirm();
        ...
        {
            var result = await _shoppingCartWriteRepository.DeleteShoppingCartByUser(userId, productId);
            return result;
        }

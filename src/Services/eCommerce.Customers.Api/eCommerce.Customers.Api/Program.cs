using eCommerce.Customers.Api.Config;
...
using eCommerce.Customers.Core.Helpers.BadRequests;
using eCommerce.Customers.Core.Helpers.Log;
using eCommerce.Customers.Core.Helpers.Mappers;
using eCommerce.Customers.Infraestructure.Models.UnitOfWorks;
using eCommerce.Customers.Infraestructure.Repositories;
using eCommerce.Customers.Infraestructure.Services;
...
var basePath = AppConfiguration.Configuration["AppConfiguration:Log:SeqFilePath"].ToString() + "\\" + "Customer";
...
{
    options.AddPolicy("read:customer", policy => policy.Requirements.Add(new HasScopeRequirement("read:customer", AppConfiguration.Configuration["AppConfiguration:Authentication:Authority"].ToString())));
    options.AddPolicy("create:customer", policy => policy.Requirements.Add(new HasScopeRequirement("create:customer", AppConfiguration.Configuration["AppConfiguration:Authentication:Authority"].ToString())));
    options.AddPolicy("update:customer", policy => policy.Requirements.Add(new HasScopeRequirement("update:customer", AppConfiguration.Configuration["AppConfiguration:Authentication:Authority"].ToString())));
    options.AddPolicy("read:identificationtype", policy => policy.Requirements.Add(new HasScopeRequirement("read:identificationtype", AppConfiguration.Configuration["AppConfiguration:Authentication:Authority"].ToString())));
});

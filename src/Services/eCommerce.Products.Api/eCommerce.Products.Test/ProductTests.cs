...
namespace WebApiProductsTest
{
    public  class ProductTests
    {
        ...
        public async Task Get_Produt_Successful() 
        {
            ...
            ProductController controlller = new (productService.Object, mapper.Object, logger.Object);
        ...
        {
            var logger = new Mock<ILogger<ProductReviewController>>();
            var productService = new Mock<IProductServices>();
            var productId = 1000;
            ...
            ProductReviewController controlller = new(productService.Object, logger.Object);
